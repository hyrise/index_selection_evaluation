...
class TestEpicAlgorithm(unittest.TestCase):
    def setUp(self):
        ...
        query_1 = Query(0, 'SELECT * FROM TableA WHERE ColA = 4;',
                        [self.column_1])
        query_2 = Query(
            1,
    ...
    def test_evaluate_combination_worse_ratio(self):
        ...
        cost = self.algo.cost_evaluation.calculate_cost(self.workload,
                                                        new_index_combination,
                                                        store_size=True)
    ...
    def test_calculate_best_indexes_scenario_3(self):
        query_1 = Query(0, 'SELECT * FROM TableA WHERE ColA = 1 AND ColB = 2;',
